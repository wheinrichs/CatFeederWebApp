...
export default function SignUp() {
  ...
  const [passwordsMeetCritera, setPasswordsMeetCriteria] = useState<Boolean>(false);
  ...
  return (
    <div className="container-fluid vh-100 d-flex justify-content-center align-items-center bg-secondary bg-opacity-50">
      <div className="border border-2 border-secondary rounded p-2 text-center" style={{ width: "600px", overflow: "auto" }} // Set fixed width and height
      >
        <h1>Sign Up</h1>
        <h4>
        ...
        { passwordsMatch && passwordsMeetCritera && usernameAvailable && (
          <div>
        <button className="btn btn-primary mt-1 mb-1" onClick={submitNewUser}> Submit</button> <br />
        </div>
        )}
